...
@Component({
  selector: 'app-device-visitor-type-report',
  templateUrl: './device-visitor-type-report.component.html',
  styleUrls: ['./device-visitor-type-report.component.scss']
})
export class DeviceVisitorTypeReportComponent implements OnInit, OnDestroy {
