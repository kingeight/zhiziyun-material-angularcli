...
@Component({
  selector: 'app-device-visitor-all-report',
  templateUrl: './device-visitor-all-report.component.html',
  styleUrls: ['./device-visitor-all-report.component.scss']
})
export class DeviceVisitorAllReportComponent implements OnInit, OnDestroy {
